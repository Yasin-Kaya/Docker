...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "yasinskey"
    security_groups = ["yasin-docker-sec-gr-203"] # !!!!!!!!!!!!
    tags = {
        Name = "yasin-Web Server of Bookstore"
    }
    user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          FOLDER="https://$TOKEN@raw.githubusercontent.com/Kaya-Y/Docker/main/"
